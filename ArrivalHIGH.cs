...
namespace DESQT
{
    class ArrivalHIGH : Event
    {
        public static Packet c;
        public static void PArrivalHIGH(String chose, Boolean finite, float ma, float ms, int p)
        {
            if (finite == true)
            {
                ...
                {
                    case "M":
                        ArrivalHIGH s2 = new ArrivalHIGH();
                        float a2;
                        do
                        {
                        ...
                        break;
                    case "G":
                        ArrivalHIGH s1 = new ArrivalHIGH();
                        float a;
                        do
                        {
                        ...
                        break;
                    case "D":
                        ArrivalHIGH s3 = new ArrivalHIGH();
                        float a3;
                        do
                        {
